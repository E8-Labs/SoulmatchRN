        ...
        <View style={{ display: 'flex', alignItems: 'center' }}>
            <View style={{ width: 370 / 430 * width }}>
                ...
                <View>
                    {package_limit.map((item, index) => (
                        <View key={item.id} style={{ display: 'flex' }}>
                            {index === 2 ? (
                                <View style={{ borderWidth: 1, borderColor: '#E6E6E6', height: 150 / 930 * height, width: 370 / 430 * width, borderRadius: 14, display: 'flex', alignItems: 'center', marginTop: 30 / 930 * height, backgroundColor: '#6050DC' }}>
                                    <Text style={{ marginTop: 8 / 930 * height, fontSize: 14, fontWeight: '500', color: 'white' }}>
                                        Recomended
                                    </Text>
                                    <View style={{ borderWidth: 1, borderColor: '#E6E6E6', height: 95 / 930 * height, width: 348 / 430 * width, borderRadius: 14, display: 'flex', alignItems: 'center', justifyContent: 'center', marginTop: 9 / 930 * height, backgroundColor: '#ffffff' }}>
                                        <View style={{ height: 55 / 930 * height, width: 316 / 430 * width, flexDirection: 'row' }}>
                                            <View style={{ width: '50%' }}>
                                                <Text style={{ fontWeight: '600', fontSize: 14, color: '#666666' }}>
                                                    Monthly
                                                </Text>
                ...
                <Modal
                    ...
                    animationType='slide'
                >
                    <View style={{ height: height, backgroundColor: '#00000010', display: 'flex', alignItems: 'center', justifyContent: 'flex-end' }}>
                        <View style={{ height: '50%', backgroundColor: 'white', width: '100%', borderTopLeftRadius: 20, borderTopRightRadius: 25, display: 'flex', alignItems: 'center' }}>
                            <View style={{ width: 370 / 430 * width }}>
                                <View style={{ display: 'flex', justifyContent: 'space-between', flexDirection: 'row', marginTop: 20 / 930 * height }}>
                                    <TouchableOpacity>
                                        <Image source={require('../../assets/Applepay.png')} style={{ height: 25 / 930 * height, width: 63 / 430 * width, resizeMode: 'contain' }} />
                                    </TouchableOpacity>
                            ...
                            <View style={{ width: 370 / 430 * width, marginTop: 20 / 930 * height, borderWidth: 1, height: 88 / 930 * height, display: 'flex', alignItems: 'center', justifyContent: 'center', borderColor: '#CCCCCC80', borderRadius: 10 }}>
                                {/* Code for payment width apple card */}
                                <View style={{ height: 54 / 930 * height, width: 330 / 430 * width, display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                                    <Image source={require('../../assets/credit.png')} style={{ height: 24 / 930 * height, width: 37 / 430 * width }} />
                                    <View style={{ height: 56 / 930 * height, width: 233 / 430 * width, display: 'flex', justifyContent: 'space-between' }}>
                                        <Text style={{ fontWeight: '500', fontSize: 14, color: '#4D4D4D', height: 20 / 930 * height }}>
                                            Apple Card
                                        </Text>
                                        <View style={{ flexDirection: 'row', display: 'flex', alignItems: 'center', gap: 5 }}>
                                            <Text style={{ fontWeight: '900', color: '#4D4D4D', marginBottom: 6 }}>
                                                ...
                                            </Text>
                            ...
                            <View style={{ height: 95 / 930 * height, width: 370 / 430 * width, borderRadius: 20, display: 'flex', alignItems: 'center', justifyContent: 'center', marginTop: 30 / 930 * height }}>
                                <View style={{ height: 65 / 930 * height, width: 338 / 430 * width, flexDirection: 'row', }}>
                                    <View style={{ width: '50%', display: 'flex', justifyContent: 'space-between' }}>
                                        <Text style={{ fontWeight: '600', fontSize: 14, color: '#666666' }}>
                                            Pay SoulMatch
                                        </Text>
                                        <Text style={{ fontWeight: '600', fontSize: 18 }}>
                            ...
                            <Text style={{ fontWeight: '500', fontSize: 14, marginTop: 20 / 930 * height, color: '#4D4D4D' }}>
