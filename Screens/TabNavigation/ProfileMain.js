    ...
    try {
      ...
      if (data) {
        ...
        const response = await fetch(ApiUrl, {
          ...
          body: JSON.stringify({ user: d.user.id }), // parameters not required here
        });
      ...
      <View style={{ height: height, width: width - 60, alignItems: "center" }}>
        ...
        >
          ...
          >
            ...
            >
              <Text style={{ color: colors.blueColor, fontSize: 14 }}>
                Public view
              </Text>
              <Image
                source={require("../../assets/images/profileView.png")}
                style={{
        ...
        <Image
          source={profileImg ? { uri: user.profile_image } : placholder}
          onLoadStart={() => {
            setLoadImage(true);
          }}
          onLoadEnd={() => {
          ...
          style={{
            height: (110 / 930) * height,
            width: (110 / 930) * height,
            borderRadius: 55,
            ...
            >
              ...
              >
                <View style={styles.mainView}>
                  ...
                  <Image
                    source={require("../../assets/images/farwordArrowIcon.png")}
                ...
                <View style={styles.mainView}>
                  ...
                  >
                    <Image
                      ...
                      style={styles.imageStyle}
                    />
                    <Text style={styles.text}>Boost Profile</Text>
                  </View>
                  <Image
                    source={require("../../assets/images/farwordArrowIcon.png")}
                    style={styles.arrowIcon}
              ...
              <LogoutPopup
                ...
                subtitle="Are you sure you want to delete your profile?"
