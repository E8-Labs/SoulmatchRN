...
export const DateFilterpoupAdmin = ({ route, onClose, flterAddress }) => {
                ...
                <View style={styles.container}>
                    ...
                    <GooglePlacesAutocomplete
                        ...
                        styles={{
                            ...
                            textInput: {
                                backgroundColor: '#00000020', // Change the background color of the text input
                                height: 44,
                                borderRadius: 5,
                                paddingVertical: 5,
