        ...
        <View style={{ height: height, alignItems: 'center' }}>
            {
                fromScreen === "LikesList" ? (
                    <View style={{ flexDirection: 'row', alignItems: 'center', width: width - 60, gap: 15, marginTop: 30 / 930 * height }}>
            ...
            <ScrollView style={{ marginBottom: 20 }} showsVerticalScrollIndicator={false}>
                ...
                <Image source={require('../../assets/images/card1.png')}
                    style={{ height: height * 0.7, width: width - 30, resizeMode: 'contain', borderRadius: 20, marginTop: 30 / 930 * height }}
                />
                <View
                    style={{
                ...
                <View style={{ height: 92 / 930 * height, width: width - 30, padding: 20, elevation: 5 }}>
                    ...
                    renderItem={({ item }) => (
                        <View key={item.id} style={{
                            ...
                            <Image source={item.image}
                                style={{ height: 230 / 930 * height, width: 350 / 430 * width, borderRadius: 10, }}
                            />
                        </View>
                    )}
                />
                            ...
                            <Text style={{ fontSize: 16, fontFamily: customFonts.reqular, color: '#4D4D4D' }}>If you could visit any country in the world, where would you go and why?</Text>
                            {
                                item.image ? (<>
                                    ...
                                    <TouchableOpacity style={{
                                        alignSelf: 'flex-end', position: 'absolute', bottom: 26, right: 30, backgroundColor: '#fff',
                                        borderRadius: 30,
                                    }}
                                        onPress={() => {
                                            handleOnpress(item)
